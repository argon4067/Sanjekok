$(document).ready(function () {
    ...
    /* 질병 리스트 */
    const disList = ["진폐증", "소음성난청", "이상기압", "진동장해", "물리적인자기타", "이황화탄소", "트리클로로에틸렌(TCE)", "기타유기화합물", "벤젠", "타르", "염화비닐", "디이소시아네이트", "석면", "기타화학물질", "연", "수은", "크롬", "카드뮴", "망간", "감염성질환", "독성간염", "직업성피부질환", "직업성암", "직업병기타", "뇌혈관질환", "심장질환", "신체부담작업", "비사고성요통", "사고성요통", "수근관증후군", "간질환", "정신질환", "작업관련성 기타"];
