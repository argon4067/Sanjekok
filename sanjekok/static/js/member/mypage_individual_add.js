$(document).ready(function () {
    ...
    const industryMap = {
        ...
        "제조업": ["식료품제조업", "섬유 및 섬유제품 제조업", "목재 및 종이제품 제조업", "출판·인쇄·제본업", "화학 및 고무제품 제조업", "의약품·화장품·연탄·석유제품제조업", "기계기구·금속·비금속광물제품제조업", "금속제련업", "전기기계기구·정밀기구·전자제품제조업", "선박건조 및 수리업", "수제품 및 기타제품 제조업"],
    ...
    /* 질병 리스트 */
    const disList = ["직업병", "진폐증", "소음성난청", "이상기압", "진동장해", "물리적인자기타", "이황화탄소", "트리클로로에틸렌(TCE)", "기타유기화합물", "벤젠", "타르", "염화비닐", "디이소시아네이트", "석면", "기타화학물질", "연", "수은", "크롬", "카드뮴", "망간", "감염성질환", "독성간염", "직업성피부질환", "직업성암", "직업병기타", "작업관련성 질병", "뇌혈관질환", "심장질환", "신체부담작업", "비사고성요통", "사고성요통", "수근관증후군", "간질환", "정신질환", "작업관련성 기타"];
